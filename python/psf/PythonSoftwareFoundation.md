...
For more details, please also have a look at the [PSF section](http://www.python.org/psf/) section on the main python.org web site.
...
- [PSF Officers](http://www.python.org/psf/members/#officers) \-- Our officers take care of the day-to-day business.

- [PSF Committees](http://www.python.org/psf/committees) \-- This lists the committees that are currently active in the PSF.
...
Website: [http://brochure.getpython.info/](http://brochure.getpython.info/)
...
The PSF started a grants program to fund Python-related conferences, activities and development. For more information, see [PSF Grants](http://www.python.org/psf/grants/).
