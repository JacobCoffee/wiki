...
[Home page](http://drbrett.ca/).
:::

::: 
### [Raymond Hettinger](#id3)
...
- CEO of [Holden Web LLC](http://www.holdenweb.com)

[Loosely Python-related blog](http://holdenweb.blogspot.com/) \| [Vaguely Open Source blog](http://onyourdesktop.blogspot.com/) \| [Yorkshireman in America](http://yorksamerica.blogspot.com/)
:::

::: 
### [Stephan Deibel](#id5)

I\'m the current chairman of the board of the PSF (since 2004) and will be running again as a director. I\'m also co-founder of Wingware, maker a commercial IDE for Python, and have been involved with various advocacy related efforts such as the somewhat dated [pythonology.org website](http://pythonology.org) and the [Python Success Stories collection](http://pythonology.org/success) (which are [also on python.org](http://python.org/about/success)). I\'ve been using Python since 1998.

In my past work for the PSF, I\'ve concentrated on trademarks and licensing. I worked with legal counsel on the [trademark policy](http://www.python.org/psf/trademarks/), drafted parts of the [license FAQ](http://wiki.python.org/moin/PythonSoftwareFoundationLicenseFaq), and respond to questions on trademarks and licensing that are emailed to the board mailing list.

I\'ve also supported funding of the website redesign (where I also participated as a volunteer), paying nominal salaries for the critical work done by the Treasurer (Kurt Kaiser) and Secretary (David Goodger), funding Jeff Rush in the [Python Advocacy Coordinator](http://wiki.python.org/moin/PythonAdvocacyCoordinator) position, and donating to Python conferences around the world.

Recently, I wrote up an article on the PSF that was just published in volume 2 issue 4 of [The Python Papers](http://pythonpapers.org/).
