...
# 2014 Google Summer of Code Proposal Template 
...
It is **HIGHLY RECOMMENDED** that you submit your proposal early and make changes as you refine it with your mentors. You can make changes in Melange up until the final deadline on March 21, 2014 19:00 UTC (note the time and time zone). No late proposals will be accepted by Google, even if there is a technical problem with the system, so submit early to avoid problems! You may indicate at the top that the current version is a draft or otherwise let us know if you don\'t want us to look at it yet.

## Sub-organization information 

- Sub-organization with whom you hope to work(\*):

  (e.g. SunPy, Mercurial, etc. See [SummerOfCode/2014](2014) for the list of valid sub-organizations)
...
- Proposal Title (\*)
  - The name of your proposal. This should explain in a few words what you plan to do and include the name of your sub-org. e.g. \"Mailman: SNMP support\" or \"Kivy: Graphics Pipeline Enhancements.\"
- Proposal Abstract (\*)
...
- Proposal Detailed Description/Timeline (\*)
  ...
  - Note that any pre-work such as setup and reading documentation should take place during the community bonding period (April 21-May 18). Students will be expected to start producing code starting on May 19th.
...
- Please indicate any vacations or other time off that you may be taking or expecting to take over the course of the summer. Any time that you would not be expecting to work should be noted here, along with a reason. (e.g. \"June 12-15th, travel for my sister\'s wedding\") Google expects you to work 40h/week for the entire GSoC period, so consider how you will make up any lost time.
- Please indicate any other commitments you have that you think we should know about.
...
**\*PLEASE DO NOT CONTACT THE GSoC ADMINISTRATORS ABOUT YOUR PROPOSALS\*** Students should be contacting the mentors and the sub-organizations about projects and proposals. It is ultimately the mentors for each project who select students, so they are your most valuable resource for what constitutes a great proposal.

Mentors are often available on IRC, as well as the respective sub-organizations mailing lists. The mailing list for each sub-org is listed here: [SummerOfCode/2014](2014). As a reciprocal courtesy students are expected to also be regularly available on IRC and/or available via e-mail and reasonably responsive to questions and requests for improvements. Students are encouraged to help other students with proposals and help answer questions in IRC or the mailing lists.

If for any reason you have not been able to find a mentor who can help you with your proposal, or you have a question that you think will be relevant to more than just your sub-organization, you can direct your questions to the [soc2014-general@python.org](mailto:soc2014-general@python.org) mailing list. You should sign up here before you post: [http://mail.python.org/mailman/listinfo/soc2014-general/](http://mail.python.org/mailman/listinfo/soc2014-general/)
