...
To build and run the site, see [build/README](https://svn.python.org/www/trunk/beta.python.org/build/README) in the checked-out beta.python.org tree.
...
[CategoryPythonWebsite](CategoryPythonWebsite) [CategoryDevelopmentProcess](CategoryDevelopmentProcess)
