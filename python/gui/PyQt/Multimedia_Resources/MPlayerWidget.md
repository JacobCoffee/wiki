...
Henning Schröder posted a link to his PyQt (Qt 3) MPlayer wrapper widget in [a message](http://www.riverbankcomputing.com/pipermail/pyqt/2007-June/016277.html) to [the mailing list](../TheMailingList). He has kindly donated the code to the community, and it can also be obtained from this page.
