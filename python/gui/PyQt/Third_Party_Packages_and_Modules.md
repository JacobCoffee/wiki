...
Author: K.S.Sreeram\
Link: [http://tachyon.in/davinci/](http://tachyon.in/davinci/)

## fman build system 

fbs compiles the Python code of your PyQt application into a standalone executable and installer. It is based on PyInstaller but solves many of its common pain points. fbs open sources solutions that were originally implemented in months of labour for the cross-platform file manager [https://fman.io/](https://fman.io/).\
Link: [https://build-system.fman.io](https://build-system.fman.io)
...
Link: [http://ivupy.sourceforge.net/](http://ivupy.sourceforge.net/)

## Matplotlib (Qt backend) 

matplotlib is a python 2D plotting library which produces publication quality figures in a variety of hardcopy formats and interactive environments across platforms.\
Author: John Hunter and contributors\
Link: [http://matplotlib.sourceforge.net/](http://matplotlib.sourceforge.net/)
...
Link: [http://openalea.gforge.inria.fr/](http://openalea.gforge.inria.fr/)
...
Link: [http://paul.giannaros.org/pate/](http://paul.giannaros.org/pate/)
...
Link: [http://pivy.coin3d.org/](http://pivy.coin3d.org/)

## PyGUIUnit 

PyGUIUnit is a framework created for testing GUIs.\
Authors: Fabio Zadrozny and Bruno da Silva de Oliveira\
Link: [http://pyguiunit.sourceforge.net/](http://pyguiunit.sourceforge.net/)

## PyKHTML 

A Python module for writing website scrapers/spiders.\
Author: Paul Giannaros\
Link: [http://paul.giannaros.org/pykhtml/](http://paul.giannaros.org/pykhtml/)
...
Bindings for libraries of [Quantum GIS](http://qgis.org/) that enable rapid development of GIS applications.\
Author: Martin Dobias\
Link: [http://www.qgis.org/wiki/Python_Bindings](http://www.qgis.org/wiki/Python_Bindings)
...
Maintainer: lcampagn\
Link: [https://launchpad.net/pyqtgraph](https://launchpad.net/pyqtgraph)
...
Author: Gerard Vermeulen\
Link: [http://pyqwt.sourceforge.net/](http://pyqwt.sourceforge.net/)
