...
Additional Contact Information Name: Email: Phone:

Mailing Address

Company Information Company: Phone: Address: Fax:
...
Sponsor Level: Amount: Additional Amount: Total:

Payment Type Check / DD payable to Indian Python Software Foundation Bank Transfer to Indian Python Software Foundation A/C \...\...\... Other

Payment Information Full payment in Indian Rupees must accompany this form in order to secure your space as a sponsor.
...
1.  Color vector image (SVG, EPS, AI) with text converted to outlines;
...
Contract Signature Sponsor: Title : Date:
