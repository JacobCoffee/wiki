...
:gutter: 2
:padding: 0
:class-container: topic-grid

:::{grid-item-card} Beginners
:link: python/getting-started/BeginnersGuide.html
:link-type: url
...
:::{grid-item-card} GUI Programming
:link: python/gui/GuiProgramming.html
:link-type: url
:class-card: topic-card
...
:::{grid-item-card} IDEs & Editors
:link: python/editors/IntegratedDevelopmentEnvironments.html
:link-type: url
:class-card: topic-card
...
:::{grid-item-card} Conferences
:link: python/conferences/regional/PythonConferences.html
:link-type: url
:class-card: topic-card
...
:link: python/science/NumericAndScientific.html
:link-type: url
:class-card: topic-card
...
:link: python/multimedia/GameProgramming.html
:link-type: url
:class-card: topic-card
