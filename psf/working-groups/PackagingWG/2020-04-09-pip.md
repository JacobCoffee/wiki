...
- pip output messages - how closely do we have to match current? (UX inputs would be great)
  ...
  - Past Pradyun wanted to redo the entire output, partly because of this problem. ![:)](/wiki/europython/img/smile.png%20":)") [https://github.com/pypa/pip/issues/4649](https://github.com/pypa/pip/issues/4649)
